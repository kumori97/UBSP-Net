...
def torch_pose_obj_data(batch_size=1):
    ...
    """
    body25_reg = pkl.load(open(join(ROOT,'body25_regressor.pkl'), 'rb'), encoding="latin1").T
    face_reg = pkl.load(open(join(ROOT, 'face_regressor.pkl'), 'rb'), encoding="latin1").T
    hand_reg = pkl.load(open(join(ROOT, 'hand_regressor.pkl'), 'rb'), encoding="latin1").T
